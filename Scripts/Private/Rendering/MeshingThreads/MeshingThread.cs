...
namespace VoxelPlay
{
    ...
    public struct MivEntry {
        public int voxelindex;
        public VoxelDefinition renderingVoxelDefinition;
    }
    ...
    public abstract class MeshingThread
    {
        ...
        public static readonly Vector3[] faceVerticesCross1 =  {
            new Vector3 (-PHI, -0.5f, PHI),
            new Vector3 (-PHI, 0.5f, PHI),
            new Vector3 (PHI, -0.5f, -PHI),
            new Vector3 (PHI, 0.5f, -PHI)
        };
        public static readonly Vector3[] faceVerticesCross2 =  {
            new Vector3 (-PHI, -0.5f, -PHI),
            new Vector3 (-PHI, 0.5f, -PHI),
            new Vector3 (PHI, -0.5f, PHI),
            new Vector3 (PHI, 0.5f, PHI)
        ...
        protected bool allowAO, enableColliders, enableNavMesh, enableTinting;
        ...
        public virtual void Init (int threadId, int poolSize, VoxelPlayEnvironment env)
        {
            ...
            this.allowAO = env.enableSmoothLighting && !env.draftModeActive;
            ...
            for (int k = 0; k < meshJobs.Length; k++) {
                ...
                meshJobs [k].mivs = new FastList<MivEntry> ();
            }
