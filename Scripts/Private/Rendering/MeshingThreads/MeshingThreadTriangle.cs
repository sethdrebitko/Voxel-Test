        ...
        public override void GenerateMeshData() {
                        ...
                        switch (type.renderType) {
                            ...
                            case RenderType.OpaqueNoAO: {
                                    ...
                                    if (v1b < FULL_OPAQUE) {
                                        ...
                                        } else if (type.customTextureVariationsProviderBack != null) {
                                            textureIndex = type.customTextureVariationsProviderBack(textureIndex, chunk.position + pos, rotationIndex);
                                        }
                                    ...
                                    if (v1f < FULL_OPAQUE) {
                                        ...
                                        } else if (type.customTextureVariationsProviderForward != null) {
                                            textureIndex = type.customTextureVariationsProviderForward(textureIndex, chunk.position + pos, rotationIndex);
                                        }
                                    ...
                                    if (v1l < FULL_OPAQUE) {
                                        ...
                                        } else if (type.customTextureVariationsProviderLeft != null) {
                                            textureIndex = type.customTextureVariationsProviderLeft(textureIndex, chunk.position + pos, rotationIndex);
                                        }
                                    ...
                                    if (v1r < FULL_OPAQUE) {
                                        ...
                                        } else if (type.customTextureVariationsProviderRight != null) {
                                            textureIndex = type.customTextureVariationsProviderRight(textureIndex, chunk.position + pos, rotationIndex);
                                        }
                                    ...
                                    if (v1u < FULL_OPAQUE) {
                                        ...
                                        } else if (type.customTextureVariationsProviderTop != null) {
                                            textureIndex = type.customTextureVariationsProviderTop(textureIndex, chunk.position + pos, rotationIndex);
                                        }
                                    ...
                                    if (v1d < FULL_OPAQUE) {
                                        ...
                                        } else if (type.customTextureVariationsProviderBottom != null) {
                                            textureIndex = type.customTextureVariationsProviderBottom(textureIndex, chunk.position + pos, rotationIndex);
                                        }
            ...
            for (int k = 0; k < VoxelPlayEnvironment.MAX_MATERIALS_PER_CHUNK; k++) {
                if (env.renderingMaterials[k].greedyMesherLitAO != null) {
                    env.renderingMaterials[k].greedyMesherLitAO.FlushTriangles(tempChunkVertices, meshJobs[jobIndex].indexBuffers[k], tempChunkUV0, tempChunkNormals, enableTinting ? tempChunkColors32 : null);
                }
                if (env.renderingMaterials[k].greedyMesherLit != null) {
                    env.renderingMaterials[k].greedyMesherLit.FlushTriangles(tempChunkVertices, meshJobs[jobIndex].indexBuffers[k], tempChunkUV0, tempChunkNormals, enableTinting ? tempChunkColors32 : null);
                }
